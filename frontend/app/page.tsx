                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-xs text-yellow-200/80">
                      Нейронная сеть требует <strong>ровно 12 каналов Sentinel-2</strong>. Используйте кнопку "Объединить отдельные каналы" для создания 12-канального файла из отдельных спектральных каналов B01-B12.
                    </div>
                  </div>
                </div>
              </div>
